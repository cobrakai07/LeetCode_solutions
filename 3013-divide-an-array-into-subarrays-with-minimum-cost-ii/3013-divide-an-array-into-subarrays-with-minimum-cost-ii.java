class Solution {
    public long minimumCost(int[] nums, int k, int dist) {
        ...
        int n = nums.length;
        long currsum = 0l; // sum of cost of all subarays in a window

        // populate currset and futureset
        // currset = top k-1 min elements
        // futset = remaining elements of the window
        ...
        for(int i=1; i < n-1-dist; i++) {
            ...
            int leftInd = i;
            // add and remove element from the same set
